...
static struct attribute_group spi_nor_attr_group = {
	.name		= NULL,
...
static int spi_nor_probe(struct spi_mem *spimem)
{
	...
	ret = sysfs_create_group(&spi->dev.kobj, &spi_nor_attr_group);
	if (ret)
		return ret;
...
static int spi_nor_remove(struct spi_mem *spimem)
{
	...
	spi_nor_restore(nor);
	sysfs_remove_group(&spi->dev.kobj, &spi_nor_attr_group);
